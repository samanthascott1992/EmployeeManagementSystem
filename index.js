...
function init() {
    const logoText = logo({ name: "Employee Application" }).render();
...
async function viewEmployeesByDepartment() {
  ...
  const employees = await db.findAllEmployeesByDepartment(departmentName);
  ...
  const { managerId } = await prompt([
    {
      type: "list",
      name: "managerId",
      message: "Which employee do you want to see subordinates for?",
...
function quit() {
  console.log("See You Again Real Soon!!");
  process.exit();
}
}
